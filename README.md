...
PostCSS generates s source map for its changes:
...
Some Grunt plugins modify CSS with regular expressions but using a CSS parser and a
node tree are a much safer way to edit CSS. Also, regexps will break source maps
