...
the original position of your code in the source files,
before any transformations were applied. For example, an inspector can show
the position of a rule in a Sass source file, even if that file was compiled
to CSS, concatenated, and minified.
