...
module.exports = function (input) {
    var tokens = Array(); // new Array() gives a performance boost by not converting the array to a slow sparse style array so use this over []
    var css    = input.css.valueOf();

    var code, next, quote, lines, last, content, escape,
        nextLine, nextOffset, escaped, escapePos, bad;
