...
var BLANKS = ' \n\r\t\f\x0b\xa0\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u200b\u2028\u2029\u3000' + String.fromCharCode(65279);
...
class Tokenizer {
    ...
    isBlank(chr) {
        return this.blanksObjs[chr];
    }

    initBlanks() {
        this.blanksObjs = {};
        BLANKS.split('').forEach(el => this.blanksObjs[el] = 1);
    }
        ...
        while ( this.move() ) {
            switch(this.letter) {
                ...
                case ";":
                    ...
                    break;
                default:
                    if(this.isBlank(this.letter)) {
                        this.space();
                    } else if(this.letter === '/' && this.next === '*') {
                        this.comment();
                    } else {
                        this.word();
                    }
    ...
    atWord() {
        ...
        while ( true ) {
            content += this.letter;
            if ( this.next && this.isBlank(this.next) ) break;
            if ( this.next == '{' ) break;
            if ( this.next == '/' ) break;
            if ( this.next == '"' ) break;
            if ( this.next == "'" ) break;
