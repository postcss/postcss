...
module.exports = function (input) {
    ...
    var code, next, quote, lines, last, content, escape,
        nextLine, nextOffset, escaped, escapePos, type;
    ...
    while ( pos < length ) {
        ...
        switch ( code ) {
            ...
            case at:
                ...
                type = (escape == pos) ? 'word' : 'at-word';
                tokens.push([type, css.slice(pos, next + 1),
                    line, pos  - offset,
                    line, next - offset
                ]);
                pos = next;
